<%-- 
    Document   : newvehicle
    Created on : Dec 12, 2016, 12:44:19 AM
    Author     : dell
--%>
...
<!--				<div class="search-box">
		...
		<div id="page-wrapper">
			<div class="main-page">
                            ...
                            <br/>                            
                            <h3 class="title1">New Vehicle</h3>
                            
                            <% //String servletParam = "add"; %>
                            <% //request.setAttribute(servletParam,servletParam); %>
						...
						<div class="form-body">
							<form action="${pageContext.request.contextPath}/ManageVehicleServlet" method="post" > 
                                                            <div class="form-group"> 
                                                                <label for="exampleInputText1">Model</label> 
                                                                <input type="text" class="form-control" name="vmodel" placeholder="Model"> 
                                                            </div> 
                                                            <div class="form-group"> 
                                                                <label for="exampleInputEmail1">Color</label> 
                                                                <input type="text" class="form-control" name="vcolor" placeholder="Color"> 
                                                            </div> 
                                                            <div class="form-group"> 
                                                                <label for="exampleInputPassword1">Plate Number</label> 
                                                                <input type="text" class="form-control" name="vplatenumber" placeholder="Plate Number"> 
                                                            </div>
                                                            
                                                            <input type="hidden" name="hiddenflag" id="hiddenflag" value="add">
                                                            <button type="submit" name="action1" class="btn btn-primary">Save Vehicle</button> 
                                                        </form> 
						</div>
					</div>
