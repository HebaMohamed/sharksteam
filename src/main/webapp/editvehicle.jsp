...
<!--				<div class="search-box">
		...
		<div id="page-wrapper">
			<div class="main-page">
                            ...
                            <br/>                            
                            <h3 class="title1">Edit Vehicle</h3>
						...
						<div class="form-body">
							<form action="${pageContext.request.contextPath}/ManageVehicleServlet" method="post" > 
                                                            <div class="form-group"> 
                                                                ...
                                                                <input type="text" class="form-control" value="<%=selectedV.Model %>" name="vmodel" placeholder="Model"> 
                                                            </div> 
                                                            <div class="form-group"> 
                                                                <label for="exampleInputEmail1">Color</label> 
                                                                <input type="text" class="form-control" value="<%=selectedV.Color %>" name="vcolor" placeholder="Color"> 
                                                            </div> 
                                                            <div class="form-group"> 
                                                                <label for="exampleInputPassword1">Plate Number</label> 
                                                                <input type="text" class="form-control" value="<%=selectedV.Plate_number %>" name="vplatenumber" placeholder="Plate Number"> 
                                                            </div>
