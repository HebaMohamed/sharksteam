...
<html>
<head>
<title>Female Safety Warnings</title>
...
<!--						<li>
		...
		<div id="page-wrapper">
			<div class="main-page">
                            ...
                            <h3 class="title1">Female Safety Warnings</h3>

                            <br/>
                            
       <% ArrayList<FemaleWarning> warnings = (ArrayList<FemaleWarning>) request.getAttribute("warnings"); %>
    ...
    function initAutocomplete() {
        ...
        var heatarr = [];
          <% for(int i = 0; i < warnings.size(); i+=1) { %>
                  var hm = new google.maps.LatLng(<%=warnings.get(i).lat%>, <%=warnings.get(i).lng%>);
                  heatarr.push(hm);
          <%}%>
