<%-- 
    Document   : newdriver
    Created on : Dec 9, 2016, 7:00:05 PM
    Author     : dell
--%>
						...
						<div class="form-body">
							<form action="${pageContext.request.contextPath}/ManageServlet" method="post" enctype="multipart/form-data"> 
                                                            ...
                                                            <div class="form-group"> 
                                                                ...
                                                                <input type="password" class="form-control" name="dpassword" placeholder="Password"> 
                                                            </div> 
                                                            <div class="form-group"> 
                                                            ...
                                                            <button type="submit" name="action1" class="btn btn-primary">Save Driver</button> 
                                                        </form> 
						</div>
					</div>
