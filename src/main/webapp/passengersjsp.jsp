...
<!--						<li>
		...
		<div id="page-wrapper">
			<div class="main-page">
                                ...
                                <h3 class="title1">Passengers Management</h3>
...
<!--                            <div class="col-md-2">                            
				...
				<div class="blank-page widget-shadow scroll" id="style-2 div1">
                                    ...
                                    <br/>
                                    	<form class="input"action="${pageContext.request.contextPath}/PassengersServlet" method="post">
                                            <div class="col-md-12">    
					...
					<div class="col-md-12 stats-info widget-shadow">
						<table class="table stats-table ">
							...
							<tbody>
                                                            ...
                                                            <% ArrayList<Passenger> passengers = (ArrayList<Passenger>) request.getAttribute("passengers"); %>
                                                                <% for(int i = 0; i < passengers.size(); i+=1) { %>
                                                                
                                                            
								<tr>
                                                                        <th><%=passengers.get(i).ID %></th>
                                                                        <th><%=passengers.get(i).FullName %></th>
                                                                        <th><%=passengers.get(i).Email %></th>
                                                                        <th><%=passengers.get(i).Gender %></th>
                                                                        <th><%=passengers.get(i).Language %></th>
                                                                        <th><%=passengers.get(i).Phone %></th>
                                                                        
                                                                        <%if(!passengers.get(i).active){%>
                                                                        <th><span class="label label-danger">Inactive</span></th>
                                                                        <th>
                                                                            <a href="${pageContext.request.contextPath}/PassengersServlet?goflag=activate&id=<%=passengers.get(i).ID  %>"><span class="label label-success"> Activate </span></a>
                                                                        </th>
                                                                        <%}else{%>
                                                                        <th><span class="label label-success">Active</span></th>
                                                                        <th>
                                                                            <a href="${pageContext.request.contextPath}/PassengersServlet?goflag=deactivate&id=<%=passengers.get(i).ID  %>"><span class="label label-danger"> Deactivate </span></a>                                                                          
                                                                        </th>
                                                                            <%}%>
